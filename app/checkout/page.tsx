          ...
          <div className="col-span-1 lg:col-span-8 flex flex-col gap-8">
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300 p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div 
                  ...
                  className={`cursor-pointer rounded-2xl border-2 p-5 flex flex-col transition-all duration-300 transform hover:-translate-y-1 ${quantity === 1 ? `border-[#1A3626] ${darkGreen} text-white shadow-lg` : 'border-gray-100 bg-white hover:border-gray-300 text-gray-800'}`}
                >
                  ...
                  <p className={`font-black text-xl mt-auto ${quantity === 1 ? goldAccent : textDarkGreen}`}>Rp 35.000</p>
                </div>
                ...
                >
                  <div className="absolute -top-3 right-4 bg-gradient-to-r from-[#F59E0B] to-[#D97706] text-white text-[10px] font-black px-3 py-1 rounded-full shadow-md">LEBIH HEMAT</div>
                  <div className="flex justify-between items-start mb-6">
                  ...
                  <p className={`text-xs font-bold line-through mb-1 ${quantity === 2 ? 'text-gray-400' : 'text-gray-400'}`}>Rp 70.000</p>
                  <p className={`font-black text-xl mt-auto ${quantity === 2 ? goldAccent : textDarkGreen}`}>Rp 65.000</p>
                </div>
                ...
                >
                  <div className="absolute -top-3 right-4 bg-gradient-to-r from-red-500 to-rose-600 text-white text-[10px] font-black px-3 py-1 rounded-full shadow-md animate-pulse">PAKET KELUARGA</div>
                  <div className="flex justify-between items-start mb-6">
                  ...
                  <p className={`text-xs font-bold line-through mb-1 ${quantity === 3 ? 'text-gray-400' : 'text-gray-400'}`}>Rp 105.000</p>
                  <p className={`font-black text-xl mt-auto ${quantity === 3 ? goldAccent : textDarkGreen}`}>Rp 90.000</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300 p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                >
                  <div className={`absolute top-0 right-0 ${bgGoldAccent} text-[#1A3626] text-[9px] font-black px-6 py-1 transform translate-x-4 translate-y-2 rotate-45 shadow-sm`}>BEBAS BIAYA</div>
